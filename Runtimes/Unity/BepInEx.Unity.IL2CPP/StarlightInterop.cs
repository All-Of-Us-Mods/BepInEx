...
{
    [LibraryImport("starlight", EntryPoint = "write_log", StringMarshalling = StringMarshalling.Utf8)]
    public static unsafe partial void write_log([MarshalAs(UnmanagedType.LPStr)] string message);

    [LibraryImport("starlight", StringMarshalling = StringMarshalling.Utf8)]
    public static unsafe partial void flush_log();

    [LibraryImport("starlight")]
